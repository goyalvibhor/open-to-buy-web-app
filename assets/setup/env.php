...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Open to Buy - Inventory Management System');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'Spazetech Solutions');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'Vibhor Goyal');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'Login-Registration System');
...
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'user@mail.com');
